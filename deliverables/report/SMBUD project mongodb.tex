...
The idea of the project is that of building a dataset containing information about green passes ad organization releasing them. A certificate is released when a person does a vaccination or takes a test to check the presence of Covid-19. All certificates contain information about the person involved, the organization issuing the certificate and information about the vaccine or the test. \\
The purpose is to build a system allowing to check the validity of these certificates according to the latest government rules.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[] Similarly to what happens in reality, we assumed that there is one certification
	for each test/vaccine, so that a person can have different certifications associated, not all of them are valid.
            as soon as they are produced without accounting for delivery time.
...
(190 first doses, 120 second doses and 20 third doses) and 400 tests inside
...
24 hours, while vaccinations validity is 9 months.
